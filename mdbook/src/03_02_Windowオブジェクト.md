...
JavaScriptの<ruby>初心者<rt>しょしんしゃ</rt></ruby>が混乱しやすい点の一つが、オブジェクトと `const` の意外な関係です。
...
「強力なガムテープで名札が貼られた箱」をイメージしてください。ガムテープで固定されているので、名札を別の新しい箱に貼り直すことはできません。でも、箱の蓋（ふた）を一つ開けて、中に入っているお菓子を<ruby>入<rt>い</rt></ruby>れ<ruby>替<rt>かえ</rt></ruby>たり、ジャムを塗ったりすることは自由なのです。
...
いかがでしょうか？「現場監督の document くん」がいれば、ウェブページを自由自在に<ruby>操<rt>あやつ</rt></ruby>れるようになります。
...
**次は、今のページから「一つ前に戻る」など、ブラウザの履歴をさらに詳しく<ruby>操<rt>あやつ</rt></ruby>る `History` オブジェクトについても見てみますか？**
