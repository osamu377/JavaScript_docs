...
* **`document`**（ドキュメント）：
* **<ruby>意味<rt>いみ</rt></ruby>：** <ruby>今画面<rt>いまがめん</rt></ruby>に<ruby>見<rt>み</rt></ruby>えている「Webページの<ruby>白<rt>しろ</rt></ruby>い<ruby>紙<rt>かみ</rt></ruby>（HTMLの<ruby>中身<rt>なかみ</rt></ruby>）」を<ruby>捕<rt>つか</rt></ruby>まえるとき（`document.getElementById`）にいつも<ruby>使<rt>つか</rt></ruby>う<ruby>超重要<rt>ちょうじゅうよう</rt></ruby>プロパティです。 
...
<ruby>学生<rt>がくせい</rt></ruby>のゲーム<ruby>作<rt>づく</rt></ruby>りやWebサイトの<ruby>動<rt>うご</rt></ruby>き（アニメーション）で<ruby>大活躍<rt>だいかつやく</rt></ruby>するツートップです！ 
...
***
 ...
 #### 3. <ruby>学生向<rt>がくせいむ</rt></ruby>けのまとめ 
